...
from .chat_suggestion import UserChatSuggestion
...
class UserConversationControl(BasePage):
    """Manage conversation"""
    ...
    def on_building_ui(self):
        with gr.Accordion(label="Conversations", open=False):
            with gr.Row():
            ...
            if getattr(flowsettings, "KH_FEATURE_CHAT_SUGGESTION", False):
                self.chat_suggestion = UserChatSuggestion(self._app)
